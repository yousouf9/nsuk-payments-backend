...
import bookRouter from './routes/book/new';
import showbookRouter from './routes/book/show';
import fetchAllBookRouter from './routes/book/fetch-all'

import newBookRouter from './routes/category/new';
import deleteBookRouter from './routes/category/delete';
import updateBookRouter from './routes/category/update';
import fetchBookRouter from './routes/category/fetch-all';
...
app.use('/api/books', showbookRouter);
app.use('/api/books', fetchAllBookRouter);
app.use('/api/categories', newBookRouter);
app.use('/api/categories', deleteBookRouter);
app.use('/api/categories', updateBookRouter);
app.use('/api/categories', fetchBookRouter);
